...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	...
	if order == 0:
		...
		triangle_right = GLine(upper_left_x+length, upper_left_y, upper_left_x + length/2, upper_left_y + length * 0.866)
		# triangle_height = length * 0.866
		triangle_left = GLine(upper_left_x + length/2, upper_left_y + length * 0.866, upper_left_x, upper_left_y)
